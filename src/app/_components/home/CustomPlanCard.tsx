...
export default function CustomPlanCard() {
    ...
    return (
        <div className={cn(css.customPlanCard, "bg-[var(--color-primary-50)] dark:bg-[var(--color-primary-100)]")}>
            ...
            <div className={css.body}>
                ...
                <div className={cn(css.priceRow, "bg-[var(--color-primary-50)] dark:bg-[var(--color-primary-100)]")}>
